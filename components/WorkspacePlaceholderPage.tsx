        ...
        <div className="flex min-w-0 flex-col gap-5">
          <header className="surface-card rounded-[34px] px-5 py-4">
            <div>
              ...
              <h1 className="section-title mt-3 text-2xl">{title}</h1>
              <p className="muted-text mt-1 text-sm">这个模块已经可以点击进入，不会再原地无反应。</p>
            </div>
            <WorkspaceMobileNav />
          </header>
          ...
          <section className="surface-card relative overflow-hidden rounded-[38px] p-6 sm:p-8">
            ...
            <div className="pointer-events-none absolute bottom-0 right-24 h-48 w-48 rounded-full bg-violet-200/20 blur-3xl" />
            <div className="relative max-w-2xl">
              <span className="status-badge px-3 py-1 text-sm">
                开发中
              </span>
              <h2 className="section-title mt-5 text-4xl">{title}</h2>
