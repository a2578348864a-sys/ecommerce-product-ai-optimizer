...
describe("Task Image creation experience", () => {
  it("shows the editable description, 12 scenes, clear visual authority, and a single generate CTA", () => {
    ...
    expect(source).toContain("STUDIO_IMAGE_SCENE_GROUPS");
    expect(source).toContain("userCreativeDescription");
    expect(source).toContain("scenePreset");
