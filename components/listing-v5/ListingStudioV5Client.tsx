...
export function ListingStudioV5Client({ taskId }: { taskId: string }) {
  ...
  if (!taskId) return <div className="mx-auto mt-8 max-w-3xl rounded-2xl border border-amber-200 bg-amber-50 p-6 text-amber-900">请从研究任务进入 Listing Studio。</div>;
