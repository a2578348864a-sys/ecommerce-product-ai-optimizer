        ...
        <div className="flex min-w-0 flex-col gap-5">
          <header className="workspace-header">
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                <p className="eyebrow">批量分析 · 非当前主链路</p>
                <h1 className="mt-2 text-2xl font-semibold tracking-tight text-slate-950">批量分析</h1>
                <p className="mt-1 text-sm text-slate-500">
                  输入 1 个商品或最多 3 个商品清单，进行后续批量处理验证。当前主流程仍以单个商品推进为主：发现商品 → 商品研究池 → 研究历史。
                </p>
              </div>
              <div className="flex flex-wrap gap-2">
                <Link href="/opportunity-candidates" className="linear-button inline-flex h-11 items-center justify-center px-5 text-sm font-semibold">
                  商品研究池
                </Link>
          ...
          <div className="rounded-xl border border-indigo-200 bg-indigo-50/60 p-3 text-sm">
            <p className="font-semibold text-indigo-800">批量分析不是当前主链路入口</p>
            <p className="mt-1 text-xs text-indigo-700">
              可从
              <Link href="/opportunities" className="mx-0.5 font-semibold underline">发现商品</Link>
              复制候选商品，也可以直接输入 1 个商品或导入最多 3 个商品。适合后续批量处理，当前主流程仍以单个商品从
              <Link href="/opportunity-candidates" className="mx-0.5 font-semibold underline">商品研究池</Link>
              开始研究并保存到
              <Link href="/tasks" className="mx-0.5 font-semibold underline">研究历史</Link> 为主。
            </p>
          </div>
