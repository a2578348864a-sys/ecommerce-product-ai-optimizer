...
> 分支：feature/v4.1-ui-productization（起点 <redacted-hash> = v4.0.1 <redacted-hash> + 1 个本地 run-list 修复提交）；基线核对：origin/main=<redacted-hash>、v4.0.0/v4.0.1 tag 未动、工作区干净、无不明修改。
...
| 证据 | 路径 |
|---|---|
| 本地首页 · 桌面 | docs/archive/evidence/releases/v4.1/evidence/before-home-desktop.png |
| 本地 /replay · 桌面 | docs/archive/evidence/releases/v4.1/evidence/before-replay-desktop.png |
| 本地 /v4/runs · 桌面 | docs/archive/evidence/releases/v4.1/evidence/before-runs-desktop.png |
| 本地首页 · 移动 390×844 | docs/archive/evidence/releases/v4.1/evidence/before-home-mobile.png |
| 本地 /replay · 移动 390×844 | docs/archive/evidence/releases/v4.1/evidence/before-replay-mobile.png |
| 公网首页 · 桌面 | docs/archive/evidence/releases/v4.1/evidence/before-public-home.png |
