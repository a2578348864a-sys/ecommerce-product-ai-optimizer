...
> 依据：开工前 `git status --short -uall` before 清单（%TEMP%\\r13-before.txt，**191 行**）逐项归类；本清单**不是 Commit 授权**。HEAD=`<redacted-hash>`，分支=feature/v4.1-ui-productization。
...
| 路径 | 直接测试 | 进入公网候选 |
| --- | --- | --- |
| `docs/archive/releases/v4.1/FORMAL_V2_BLOCKED.md` | —（文档/证据） | 是 |
| `docs/archive/releases/v4.1/FORMAL_V2_COMPARE.md` | —（文档/证据） | 是 |
| `docs/archive/releases/v4.1/FORMAL_V2_PROGRESS.md` | —（文档/证据） | 是 |

### 正式 v2 证据截图（60）

| 路径 | 直接测试 | 进入公网候选 |
| --- | --- | --- |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/00-formal-old-home-1440x900.png` | —（文档/证据） | 是 |


| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/03-formal-old-detail-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/10-formal-new-home-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/10-formal-new-home-2560x1380.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/10-formal-new-home-390x844.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/10-formal-new-home-768x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/15-formal-research-identity-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/20-formal-new-detail-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/20-formal-new-detail-2560x1380.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/20-formal-new-detail-390x844.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/20-formal-new-detail-768x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/24-formal-new-detail-listing-images-390x844.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/action-routing-buyers-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/action-routing-buyers-390x844.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/action-routing-cost-risk-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/action-routing-cost-risk-390x844.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/action-routing-market-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/action-routing-market-390x844.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/action-routing-sourcing-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/action-routing-sourcing-390x844.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/correction-home-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/correction-home-390x844.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/correction-home-768x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/correction-task-oxo-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/correction-task-oxo-390x844.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/correction-task-oxo-768x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/correction-task-oxo-listing-images-390x844.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/entry-chain-startable-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/entry-chain-startable-390x844.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/final-active-detail-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/final-active-detail-390x844.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/final-historical-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/final-home-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/final-home-390x844.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/final-home-768x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/formal-active-detail-390x844.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/formal-home-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/formal-home-active-detail-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/formal-research-record-historical-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/r3-active-detail-oxo-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/r3-active-detail-oxo-390x844.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/r3-historical-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/r3-home-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/r8-home-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/r8-home-390x844.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/r8-startable-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/r8-startable-390x844.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/round11-1440-refresh.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/round11-1440-saved.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/round11-390-refresh.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/usability-closure-candidate-pool-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/usability-closure-commercial-inputs-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/usability-closure-commercial-inputs-open-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/usability-closure-research-1440x900.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/usability-fix-r12-1440-detail.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/usability-fix-r12-1440-expanded.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/usability-fix-r12-390-detail.png` | —（文档/证据） | 是 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/usability-fix-r12-390-expanded.png` | —（文档/证据） | 是 |
...
| `docs/archive/releases/v4.1/PROTOTYPE_V2_BLOCKED.md` | 用户既有/原型内容，未触碰 |
| `docs/archive/releases/v4.1/PROTOTYPE_V2_COMPARE.md` | 用户既有/原型内容，未触碰 |
| `docs/archive/releases/v4.1/PROTOTYPE_V2_PROGRESS.md` | 用户既有/原型内容，未触碰 |
| `docs/archive/evidence/releases/v4.1/evidence/c-prototype/product-1440x900.png` | 用户既有/原型内容，未触碰 |
| `docs/archive/evidence/releases/v4.1/evidence/c-prototype/product-390x844.png` | 用户既有/原型内容，未触碰 |
| `docs/archive/evidence/releases/v4.1/evidence/c-prototype/product-768x900.png` | 用户既有/原型内容，未触碰 |
| `docs/archive/evidence/releases/v4.1/evidence/c-prototype/product-listing-390x844.png` | 用户既有/原型内容，未触碰 |
| `docs/archive/evidence/releases/v4.1/evidence/c-prototype/workbench-1440x900.png` | 用户既有/原型内容，未触碰 |
| `docs/archive/evidence/releases/v4.1/evidence/c-prototype/workbench-390x844.png` | 用户既有/原型内容，未触碰 |
| `docs/archive/evidence/releases/v4.1/evidence/c-prototype/workbench-768x900.png` | 用户既有/原型内容，未触碰 |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/01-frozen-prototype-home-1440x900.png` | 原型基线对比截图（formal 证据目录，内容属原型） |
| `docs/archive/evidence/releases/v4.1/evidence/d-formal-v2/02-frozen-prototype-product-1440x900.png` | 原型基线对比截图（formal 证据目录，内容属原型） |
...
- HEAD：<redacted-hash>（分支 feature/v4.1-ui-productization；全程未变）。
- 审计构建 BUILD_ID：<redacted-build-id>。
- 原始 prisma/dev.db SHA-256（原生只读句柄）：<redacted-hash>（往返一致，零写入）。
