...
- 隔离构建成功（BUILD_ID <redacted-build-id>）+ <PORT> 验收: 历史坏稿 API 返回 unqualified=true/factSafe=false/copyQuality=false/正式字段空; 1440+390 显示暂无合格草稿, 无复制按钮, 正式区无坏句, 历史事实区保留 Leak Proof, 无横滚, console 0/0, 写请求 0
