...
- docs/archive/evidence/releases/v4.1/evidence/c-end/home-1440.png、list-1440.png、detail-listing-tab-1440.png、home-390.png、list-390.png、detail-390.png
...
- 等待用户视觉确认；未 push / tag / 部署；本地 <PORT> 保持 V4 flag ON 供查看。
