...
| 门禁 | 状态 | 证据 |
|---|---|---|
| Review Evidence 合同冻结 | PASS | docs/archive/releases/v3/changes/v3-4-voc/contract.md（review-evidence.v1 + voc-analysis.v1） |
...
- **1 次真实 AI analyze**（deepseek-v4-flash，runId <redacted-hash>…，completionTokens=2661，gateResult=pass，unverified=0）：
