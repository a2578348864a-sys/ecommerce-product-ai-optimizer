...
> 来源：`docs/archive/releases/v3/V3_5_PRE_IMPLEMENTATION_CONTRACT.md` §7/§8/§86
...
**证据**：`docs/archive/releases/v3/changes/v3-5-r1-spike/`（branch codex/v3-5-r1-spike，FULL PASS 记录）；正式实现见 `docs/archive/releases/v3/changes/v3-5-r1-replacement/`。
