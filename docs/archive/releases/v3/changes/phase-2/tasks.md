...
> 规格来源：docs/archive/releases/v3/changes/phase-2/{evidence-read-model,competitor-evidence-contract,proposal}.md、11_PHASE2_TASK.md、30 增强 Phase 2、novice-comprehension seed。
...
- 真 Candidate 数据路径验证（本地 <PORT> 或测试数据）
