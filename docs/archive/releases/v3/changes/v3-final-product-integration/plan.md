...
> 基线：main == origin/main == <redacted-hash> → 整改分支 `codex/v3-final-product-integration`
> 权威审计：`docs/archive/releases/v3/V3_FINAL_PRODUCT_AUDIT.md`（P0=0，P1=8：F1/F2/F3/F4/F5/F8/F10/F11；P2=5）
...
- 安全审查 + secret scan
- main 集成（safe fast-forward）+ push + <PORT> 切换
