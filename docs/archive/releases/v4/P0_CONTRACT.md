...
对 v3.1.0 集成树（基线 commit `<redacted-hash>…`，V3.1 FROZEN）做全量基线审计：回归基线、
...
- `docs/archive/releases/v4/P0_BASELINE_AUDIT_REPORT.md`
- `docs/archive/releases/v4/P0_E2E_EVIDENCE.md`
