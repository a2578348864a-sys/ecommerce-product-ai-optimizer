...
- executionBatch：V4-FINAL-R2-P6-<redacted-hash>-2340；authorityChecksum：`<redacted-hash>…`
- baseCommit：`<redacted-hash>`（P5 PASS 后 main）
...
| Owner | 路径 |
|---|---|
| Lead | docs/archive/releases/v4/P6_*、lib/v4/replay/schema.ts（bundle 契约+allowlist+hash）、app/api/v4/replay/**（导出/审批/访问）、graph/run 导出接线、Owner 审批 API、E2E |
