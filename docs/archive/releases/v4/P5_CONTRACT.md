...
- executionBatch：V4-FINAL-R2-P5-<redacted-hash>-2300；authorityChecksum：`<redacted-hash>…`
- baseCommit：`<redacted-hash>`（P4 PASS 后 main）
...
| Owner | 路径 |
|---|---|
| Lead | docs/archive/releases/v4/P5_*、lib/v4/content/handoff.ts（ContentHandoff 契约+stale）、lib/v4/content/policyPack.ts（pack 校验/过期）、graph content_handoff/content_skills/content_review 接线、app/api/v4 内容端点、UI 收口、E2E |
