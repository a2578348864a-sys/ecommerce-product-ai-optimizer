...
- executionBatch：V4-FINAL-R2-P4-<redacted-hash>-2220；authorityChecksum：`<redacted-hash>…`
- baseCommit：`<redacted-hash>`（P3 PASS 后 main）
...
| Owner | 路径 |
|---|---|
| Lead | docs/archive/releases/v4/P4_*、lib/v4/calculator/contract.ts（类型+版本冻结）、lib/v4/gateB.ts、graph commercial_check/gate_b 接线、app/api/v4 计算端点、stale 门禁 |
