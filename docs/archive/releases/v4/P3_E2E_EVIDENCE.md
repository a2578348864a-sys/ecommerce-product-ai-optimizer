...
- Journey：V4-P3-E2E-01；Commit <redacted-hash>；<PORT> local_owner flag on；recorded 工具
...
| 6 | Fact Gate 三态（run <redacted-hash>） | 自动晋级→400 auto_promotion_blocked；伪造引用→400 fact_provenance_failed；人工确认(method=document+refs)→201 | ✅ |
...
截图：page-2026-08-21T14-07-13-904Z.png（Fact Gate 控制台）等存 `/path/to/workspace`。
