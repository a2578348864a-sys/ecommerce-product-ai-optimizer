...
- executionBatch：V4-FINAL-R2-P3-<redacted-hash>-2135；authorityChecksum：`<redacted-hash>…`
- baseCommit：`<redacted-hash>`（P2 PASS 后 main）
...
| Owner | 路径 |
|---|---|
| Lead | docs/archive/releases/v4/P3_*、prisma 模型+迁移、lib/v4/factStore.ts（V4FactRecord 存取 + validator + revision）、lib/v4/gateA.ts（Gate A 载荷）、graph.ts supplier_research/product_fact_gate 接线、app/api/v4 事实端点、Fact UI 收口 |
