...
候选容器为2,143行；29个 state、5个 effect、11个 callback、6个 memo不变，ref从2增至3。9个业务 fetch、2个直接 localStorage数据域和5个间接sessionStorage活动key不变。56项组件测试包含既有44项和新增12项竞态/公开UI边界证据。
