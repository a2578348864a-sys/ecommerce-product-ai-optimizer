...
const REAL_PNG_SOURCE = "/path/to/workspace";
...
async function main() {
  ...
  try {
    ...
    const handoffSeed = {
      ...
      controlState: "active",
      createdAt,
      createdBy: { mode: "owner", subjectFingerprint: "<redacted-hash>" },
      ...
      versions: [{
        ...
        confirmedFacts: [{ factId: "<redacted-hash>-0000-4000-8000-<redacted-hash>", field: "brand", label: "品牌", value: "SyntheticBrand", evidenceTier: "human_confirmed", usageScopes: ["listing", "internal"], sourceRef: { sourceKind: "user_confirmation", sourceField: "brand", confirmedBy: { mode: "owner", subjectFingerprint: "<redacted-hash>" }, confirmedAt: createdAt, confirmationReference: "confirm:fix" }, confirmedAt: createdAt, confirmedBy: { mode: "owner", subjectFingerprint: "<redacted-hash>" } }],
        ...
        confirmation: { confirmed: true, confirmedAt: createdAt, confirmedBy: { mode: "owner", subjectFingerprint: "<redacted-hash>" } },
