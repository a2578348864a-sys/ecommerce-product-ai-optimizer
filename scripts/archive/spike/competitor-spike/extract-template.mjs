...
function printUsage() {
  ...
  node scripts/archive/spike/competitor-spike/extract-template.mjs --template [--targetAsin X] [--targetTitle Y] [--keyword Z]
  node scripts/archive/spike/competitor-spike/extract-template.mjs --validate <output.json>
`);
}
