...
function printUsage() {
  ...
  node scripts/archive/spike/keyword-spike/extract-template.mjs --template [--seed S] [--seedType keyword|asin] [--uiSurface keyword-mining-panel|reverse-asin-panel]
  node scripts/archive/spike/keyword-spike/extract-template.mjs --validate <output.json>
`);
}
