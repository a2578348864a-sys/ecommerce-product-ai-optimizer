...
export function assertMockInputIsSafe(records: readonly MockProviderCallRecord[]) {
  for (const record of records) {
    ...
    const allowedKeys = ["schema", "source", "productFacts", "stableSourceFacts", "creativeReferences", "creativePreferences", "prohibitedClaims", "unknowns", "humanReviewRequired", "researchMode", "promotionEligible", "creativeContext", "listingBrief", "copyStrategy", "englishRenderings"];
