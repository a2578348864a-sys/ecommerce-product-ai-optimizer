...
export function buildListingPromptFromInput(input: ListingGenerationInput): string {
  ...
  return [
    ...
    "- Never invent facts that do not exist in the confirmed facts above.",
    "- Never expand, upgrade or embellish material, dimensions, certifications, performance, compatibility, origin or effects beyond the confirmed values.",
