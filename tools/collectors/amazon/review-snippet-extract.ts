...
export const REVIEW_SNIPPET_EXTRACTOR_SOURCE = [
  ...
  "  // Amazon 详情页评论卡片的 textContent 会包含头像等 <img ...> 标记文本；",
  "  // 该标记只在 username 分支里被剥离，残留在 title 里会变成 '<img src=...' 开头的脏标题。",
  "  // 这里对 title 做最后一次标签剥离（与 v3-4-voc-review.smoke.test.ts 的孪生实现保持同步）。",
